...
elem* scopeSearch(stackADT stack, void* elem2, int (*cmp)(void*elem1, void*elem2));
int scopeContains(stackADT stack, void* elem2, int (*cmp)(void*elem1, void*elem2));
...
int addAssignById(scopeADT scope, int id, enum type type, void *value, int valueSize) {
  ...
  elem->value = malloc(valueSize);
  memcpy(elem->value, value, valueSize);
...
int scopeContains(stackADT stack, void* value, int (*cmp)(void*elem, void*value)){
